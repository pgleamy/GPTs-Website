...
function loadGPTEntries() {
    ...
    gptEntries.forEach(entry => {
        ...
        entryDiv.innerHTML = `
            ...
            <div>
                <a href=${entry.link}" style="color: ${entry.style.textColor}; font-weight: bold" class="hover:underline">${entry.name} onclick="trackLinkClick('${entry.name.replace(/'/g, "\\'")}');">${entry.name}</a>
                <p>${entry.description}</p>
                <a href="${entry.link}" style="color: ${entry.style.textColor}; font-weight: bold" class="hover:underline" onclick="trackLinkClick('${entry.name.replace(/'/g, "\\'")}');">${entry.name}>USE THIS GPT</a>
            </div>
        `;
